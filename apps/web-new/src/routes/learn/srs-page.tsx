...
import { type ReviewRating } from "@/features/reviews/api/reviews-api";
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="space-y-4 text-center">
          <div className="mx-auto h-12 w-12 animate-pulse rounded-sm bg-primary/20 flex items-center justify-center border border-primary/30">
            <div className="h-6 w-6 animate-spin rounded-none border-2 border-transparent border-t-primary" />
          </div>
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground">
            Analyzing SRS Matrix
          </p>
        </div>
      </div>
    );
