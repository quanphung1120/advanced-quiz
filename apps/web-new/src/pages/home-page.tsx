...
import {
  ...
  CardFooter,
  CardHeader,
} from "@advanced-quiz/ui/components/card";
import {
  Tabs,
  TabsList,
  TabsContent,
...
const contentCardClass = "h-full min-h-[18rem] p-6 sm:p-7";
const pricingCardClass = "h-full flex flex-col border border-border p-6 sm:p-7";
...
function FeatureCard({
  ...
  return (
    <motion.article variants={fadeUp} className="h-full w-full">
      <Card className={contentCardClass}>
        ...
        <CardFooter className={cn("mt-auto flex items-start -mx-6 px-6 sm:-mx-7 sm:px-7 pt-5 min-h-22", !detail && "border-t-0")}>
          {detail ? (
  ...
  return (
    <motion.article variants={fadeUp}>
      <Card className={contentCardClass}>
        ...
        <CardContent className="flex flex-1 items-center py-8">
          <p className="text-[15px] leading-8 text-foreground">
            &ldquo;{quote}&rdquo;
          </p>
        </CardContent>
        <CardFooter className="flex-col items-start gap-1 border-t-0 pt-0">
...
function PricingPlanCard({
  ...
  return (
    <motion.article variants={fadeUp} className="h-full">
      ...
      >
        <CardHeader className="border-b border-border pb-7 -mx-6 px-6 sm:-mx-7 sm:px-7">
          <div>
          ...
          {highlighted ? (
            <span className="self-start border border-primary px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-primary">
              Most popular
            </span>
          ) : null}
        </CardHeader>
        <CardContent className="flex flex-1 flex-col pt-7">
          ...
          <div className="mt-10 border-t border-border pt-8 -mx-6 px-6 sm:-mx-7 sm:px-7">
        ...
        <CardFooter className="mt-auto border-t border-border -mx-6 px-6 pt-7 sm:-mx-7 sm:px-7">
          <Link to={ctaTo} className="block w-full">
            <Button
