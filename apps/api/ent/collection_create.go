...
func (_c *CollectionCreate) SetOwnerID(v string) *CollectionCreate {
	_c.mutation.SetOwnerID(v)
	return _c
}

// SetIsPublic sets the "is_public" field.
func (_c *CollectionCreate) SetIsPublic(v bool) *CollectionCreate {
	_c.mutation.SetIsPublic(v)
	return _c
}

// SetNillableIsPublic sets the "is_public" field if the given value is not nil.
func (_c *CollectionCreate) SetNillableIsPublic(v *bool) *CollectionCreate {
	if v != nil {
		_c.SetIsPublic(*v)
	}
	return _c
...
func (_c *CollectionCreate) AddCollaboratorIDs(ids ...uuid.UUID) *CollectionCreate {
	_c.mutation.AddCollaboratorIDs(ids...)
	return _c
}

// AddCollaborators adds the "collaborators" edges to the CollectionCollaborator entity.
func (_c *CollectionCreate) AddCollaborators(v ...*CollectionCollaborator) *CollectionCreate {
...
func (_c *CollectionCreate) AddFlashcardIDs(ids ...uuid.UUID) *CollectionCreate {
	_c.mutation.AddFlashcardIDs(ids...)
	return _c
}

// AddFlashcards adds the "flashcards" edges to the Flashcard entity.
func (_c *CollectionCreate) AddFlashcards(v ...*Flashcard) *CollectionCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFlashcardIDs(ids...)
}
...
func (_c *CollectionCreate) check() error {
	...
	if _, ok := _c.mutation.OwnerID(); !ok {
		return &ValidationError{Name: "owner_id", err: errors.New(`ent: missing required field "Collection.owner_id"`)}
	}
	...
	if _, ok := _c.mutation.IsPublic(); !ok {
		return &ValidationError{Name: "is_public", err: errors.New(`ent: missing required field "Collection.is_public"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *CollectionCreate) createSpec() (*Collection, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.FlashcardsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
