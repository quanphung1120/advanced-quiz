// features/landing-page/components/features-section.tsx
...
const features = [
  {
    ...
    description:
      "Create themed collections to organize your flashcards by subject, course, or topic. Keep your learning materials structured and easy to find.",
    comingSoon: false,
  },
  {
    icon: (
    ...
    description:
      "Add flashcards with questions and answers to your collections. Build your study deck one card at a time.",
    comingSoon: false,
  },
  {
    icon: (
    ...
    title: "Study Mode",
    description:
      "Review your flashcards with a simple flip interface. Test your knowledge and mark cards as learned.",
    comingSoon: false,
  },
  {
    icon: (
    ...
    description:
      "Smart algorithm that schedules reviews at optimal intervals, ensuring you review cards just before you forget them.",
    comingSoon: true,
  },
  {
    icon: (
    ...
    description:
      "Monitor your learning journey with detailed statistics. See your retention rates, study streaks, and mastery levels.",
    comingSoon: true,
  },
  {
    icon: (
    ...
    title: "Collaborate",
    description:
      "Share collections with classmates or study groups. Build comprehensive flashcard decks together.",
    comingSoon: true,
  },
];
      ...
      <div className="container relative mx-auto max-w-6xl px-4">
        ...
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Recallly helps you organize and study your flashcards. We&apos;re
            actively building more features.
          </p>
        </div>
