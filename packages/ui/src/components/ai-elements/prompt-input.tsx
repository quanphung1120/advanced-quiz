...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@advanced-quiz/ui/components/command";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from "@advanced-quiz/ui/components/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@advanced-quiz/ui/components/select";
import { Spinner } from "@advanced-quiz/ui/components/spinner";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@advanced-quiz/ui/components/tooltip";
...
export const PromptInputHoverCard = (props: PromptInputHoverCardProps) => {
  const { openDelay, closeDelay, ...hoverCardProps } = props;
  void openDelay;
  void closeDelay;
